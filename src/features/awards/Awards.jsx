...
const Awards = () => {
  return (
    <div>
      ...
      <div className="awards-text">
        2. Courses on Backend Tools and Technologies from Simplilearn.
      </div>
      <div className="awards-text">
        3. Online Bootcamp on Database Tools and Technologies from Simplilearn.
      </div>
      <div className="awards-text">
        4. Courses on Code Versioning and Agile Tools and Technologies from
        Coursera.
      </div>
